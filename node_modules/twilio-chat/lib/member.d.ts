...
declare namespace Member {
    type UpdateReason = 'roleSid' | 'lastConsumedMessageIndex' | 'lastConsumptionTimestamp';
...
declare class Member extends EventEmitter {
     ...
     * @typedef {('roleSid' | 'lastConsumedMessageIndex' | 'lastConsumptionTimestamp')} Member#UpdateReason
     */
